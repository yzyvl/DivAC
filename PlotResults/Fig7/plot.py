...
if __name__ == '__main__':
    root_path = Path('Gassian-vs-Deterministic')
    environments = []

    colors = {"DivAC-KL": "#0000ff", "DivAC": "#ff3300", "DivAC-KL-Gaussian": "#33cc33", "DivAC-Gaussian": "#ff8000"}
    y_limit = {"Ant-v2": [-10, 6000],
               "Walker2d-v2": [-100, 5500],
               "Swimmer-v2": [5, 140],
               "InvertedDoublePendulum-v2": [-100, 10000],
